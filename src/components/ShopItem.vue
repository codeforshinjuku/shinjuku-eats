<template>
  <article class="shop">
    ...
    <div class="shop__thumbnail">
      <img v-if="images != null" :src="images" :alt="'画像：' + name" class="image" />
      <img v-else :src="'/images/placeholder' + category + '.png'" class="image" />
    </div>
    ...
    <div class="shop__icons">
      ...
      <div v-if="phone" class="icon">
        ...
        <a :href="'tel:' + phone">{{ reshapePhoneChar(phone) }}</a>
      </div>
