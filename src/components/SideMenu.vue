    ...
    <nav class="side_menu__inner">
      ...
      <div class="side_menu__heading">
        <router-link :to="{ name: 'Home' }" title="TOPページに移動します">
          <img src="/images/white_logo.svg" alt="テイクアウトとデリバリー情報" />
        </router-link>
        <p v-if="$route.name === 'area_index'" class="district">{{ $route.params["name"] }}</p>
      </div>
      ...
      <section class="side_menu__section share">
        ...
        <div class="icons">
          <a :href="facebookUrl" target="_blank" title="Facebookでこのサイトをシェアします（新規ウィンドウで開きます）">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
              <path
                fill="currentColor"
          ...
          <a :href="twitterUrl" target="_blank" title="Twitterでこのサイトをシェアします（新規ウィンドウで開きます）">
            <svg style="width:24px;height:24px" viewBox="0 0 24 24">
              <path
                fill="currentColor"
      ...
      <section class="side_menu__section about">
        ...
        <div class="text">
          ...
          <p>
            ...
            Shinjukuでは情報の正確さや各店舗のサービス内容の品質等保証いたしません。ご利用の際は各自の責任でお願いします。
          </p>
          <p>サイトに不備、情報の間違いなど見つけた方はメールにてご連絡ください。</p>
          <p>ご連絡先メールアドレス：codeforshinjuku@gmail.com</p>
        </div>
      </section>
      <section class="supported">
        ...
        <a
          ...
          target="_blank"
          title="code for Shinjukuのホームページを新規ウィンドウで開きます"
        >
          <img src="/images/shinjuku_logo_white.png" alt="code for Shinjuku" />
        </a>
      </section>
    </nav>
  </div>
